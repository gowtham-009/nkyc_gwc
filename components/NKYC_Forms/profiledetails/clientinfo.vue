    ...
    <div class="primary_color" >
        ...
        <div class="flex justify-between flex-col bg-white rounded-t-3xl dark:bg-black"
            ...
            <div class="w-full p-1 bg-gray-100 rounded-t-3xl dark:bg-gray-900">
                ...
                <Button type="button"  @click="handleButtonClick" :disabled="!father || !mother || !commAddressRef.confirm"  
...
import Checkbox from '~/components/NKYC_Forms/profiledetails/profileinputs/confirmcheckbox.vue' 
