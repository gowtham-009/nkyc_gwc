        ...
        <div class="flex justify-between  p-2 flex-col bg-white rounded-t-3xl dark:bg-black"
            ...
            <div class="w-full mt-2 px-2 p-1">
                ...
                <div class="w-full mt-3">
                    <span class="text-gray-500 text-xl font-medium ">Upload Sing</span>
                    <div class="grid grid-cols-1 gap-3 ">
                        <div>
                            <div class="overflow-hidden rounded-lg  mt-2 bg-white shadow-lg  dark:border-white">
                                <div class="px-2 py-2 ">
                                    <Sign v-model:src="imageSrcsign" />
                                </div>
                            </div>
...
import Sign from '~/components/NKYC_Forms/account/fileuploads/signature.vue';
